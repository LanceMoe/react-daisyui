...
const NavbarStart = React.forwardRef<HTMLDivElement, Omit<NavbarSectionProps, 'section'>>((props, ref) => (
  <NavbarSection {...props} section="start" ref={ref} />
));

const NavbarCenter = React.forwardRef<HTMLDivElement, Omit<NavbarSectionProps, 'section'>>((props, ref) => (
  <NavbarSection {...props} section="center" ref={ref} />
));

const NavbarEnd = React.forwardRef<HTMLDivElement, Omit<NavbarSectionProps, 'section'>>((props, ref) => (
