...
export const Default: Story<DiffProps> = ({ secondItem, ...args }) => (
  <Diff
    {...args}
    secondItem={<img alt="daisy" src="https://img.daisyui.com/images/stock/photo-1560717789-0ac7c58ac90a-blur.webp" />}
  >
...
export const Text: Story<DiffProps> = ({ secondItem, ...args }) => (
  <Diff {...args} secondItem={<div className="bg-base-200 text-9xl font-black grid place-content-center">DAISY</div>}>
