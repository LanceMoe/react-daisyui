...
describe('Drawer component', () => {
  test('Should render Drawer', () => {
    const { container } = render(<Drawer side={<div>Side content</div>}>Content</Drawer>);
  ...
  test('Should apply contentClassName to the drawer content element', () => {
    ...
    expect(container.getElementsByClassName('drawer-content')[0]).toHaveClass('custom-content');
  });
  ...
  test('Should apply sideClassName to the drawer side element', () => {
    ...
    expect(container.getElementsByClassName('drawer-side')[0]).toHaveClass('custom-side');
  });
  ...
  test('Should apply overlayClassName to the drawer overlay element', () => {
    ...
    expect(container.getElementsByClassName('drawer-overlay')[0]).toHaveClass('custom-overlay');
  });
  ...
  test('Should apply additional class names', () => {
    render(<Drawer side={<div>Side Content</div>} data-testid="drawer" className="custom-class" />);
